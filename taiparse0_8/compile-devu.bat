...
devenv user\user.sln /rebuild unicode_debug
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv kb\kb.sln /rebuild unicode_debug
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv run\run.sln /rebuild unicode_debug
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv prog.sln /rebuild unicode_debug
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort
